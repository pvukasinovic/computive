...
module axi_lite_ctrl #(
    ...
    input  logic [3:0]          s_axi_wstrb,  // AXI spec required, not used (full-word writes only)
    ...
    input  logic [DATA_W-1:0]   inf_count,
    input  logic [DATA_W-1:0]   error_code,
    input  logic [1:0]          layer_status,
